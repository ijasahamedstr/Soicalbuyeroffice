...
import './Featured gaming accounts.css';
...
function Game() {
  ...
  var settings = {
    ...
    return (
      ...
      <div style={{ marginLeft: marginLeftValue,marginTop:marginTopValue,marginBottom:marginBottomValue}}><h2>🚀 حسابات ألعاب مميزة</h2></div>
      <Slider {...settings}>
        <div className="col-12 col-sm-6 col-md-4 col-lg-3">
          ...
          <Card style={{ width: '18rem', backgroundColor:'#F2F3F4'}}>
            ...
            <Card.Title>حساب ببجي لفل 76 نوادر واسلحه مط</Card.Title>
            <Card.Body>
              <Card.Text>
                فيس السيزون وكل القصات واللحيه اسم مميز xVxV اطارات RP PLUS (s6-s7-s9) و اطار RE2 مصير مميز مشحو</Card.Text>
              <Card.Text>
