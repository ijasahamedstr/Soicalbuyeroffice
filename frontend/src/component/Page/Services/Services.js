...
function AutoLayoutExample() {
  ...
  return (
    ...
    <div className="row">
    <div style={{ marginLeft: marginLeftValue,marginTop:marginTopValue,marginBottom:marginBottomValue}}><h2 className='entry-title'>🤔لماذا منصة يوزر</h2></div>
      {/* Column for small and larger screens (col-sm-6) */}
      <div className="col-12 col-sm-6 col-md-4 col-lg-3">
        <div className="p-3">
        <div className='feature'>
        <Card style={{ width: '18rem',border:'none',backgroundColor: `rgba(var(--bs-primary-rgb), 0.1)`,height:'265px'}}>
          <Card.Body>
      ...
      <div className="col-12 col-sm-6 col-md-4 col-lg-3">
        <div className="p-3">
        <div className='feature'>
        <Card style={{ width: '18rem',border:'none',backgroundColor: `rgba(var(--bs-success-rgb), 0.1)`,height:'265px'}}>
          <Card.Body>
      ...
      <div className="col-12 col-md-4 col-lg-3">
        <div className="p-3">
        <div className='feature'>
        <Card style={{ width: '18rem',border:'none',backgroundColor: `rgba(var(--bs-info-rgb), 0.1)`,height:'265px'}}>
          <Card.Body>
      ...
      <div className="col-12 col-lg-3">
        <div className="p-3">
        <div className='feature'>
        <Card style={{ width: '18rem',border:'none',backgroundColor: `rgba(var(--bs-danger-rgb), 0.1)`,height:'265px'}}>
          <Card.Body>
